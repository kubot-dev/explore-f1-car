...
<template>
  <div class="factsWrapper">
    <div class="factHeader">
      <h3 class="factTitle">Grippy asphalt & sticky sand</h3>
      <div class="factNav">
        <svg class="arrow" width="7.6939387" height="14" viewBox="0 -4.5 0.19234847 0.35">
          <path
        ...
        <svg class="arrow" width="7.6939383" height="13.999948" viewBox="0 -4.5 0.19234846 0.34999869">
          <path
    ...
    <div class="factDescription">
      The track surface at Bahrain International Circuit is made from a special aggregate that was shipped from a quarry in England at great
      expense and offers very high levels of grip. Keeping sand off the grippy surface is more of a challenge for a circuit surrounded by
      desert in an area where sandstorms are common. To minimize the amount of sand blowing on to the circuit, the organizers spray a sticky
      adhesive substance onto the surrounding desert before the race weekend. The track is also regularly swept between sessions.
    </div>
  </div>
</template>
<style scoped>
