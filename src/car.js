...
let dataContainer;
let partLabel, partDescription, dataContent, closeBtn;
...
function init() {
  wrapper = document.querySelector('.exploreCar');
  ...
  dataContent.classList.add('dataContainer');
  dataContent.style.pointerEvents = 'auto';
  partLabel = document.createElement('h3');
  partLabel.classList.add('partLabel');
  partDescription = document.createElement('p');
  partDescription.classList.add('partDescription');
  closeBtn = document.createElement('div');
  closeBtn.classList.add('closeBtn');
  closeBtn.textContent = 'x';
  dataContent.append(partLabel, partDescription, closeBtn);
  ...
  dataContainer = new CSS2DObject(dataContent);
